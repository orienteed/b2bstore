        ...
        <div className={classes.root}>
            ...
            <div className={classes.detailsContainer}>
                <div>
                    ...
                    <span className={classes.itemsText}>
                        Items: {items?.length}
                    </span>
                </div>
                <div>
            ...
            <div className={classes.actionsWrapper}>
                ...
                <Button className={classes.shoppngBtn} priority="normal">Go back to shopping</Button>
            </div>
        </div>
    );
};
