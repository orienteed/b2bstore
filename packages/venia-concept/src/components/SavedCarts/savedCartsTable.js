...
import defaultClasses from '@orienteed/buyLaterNotes/components/SavedCarts/savedCartsTable.module.css';
import SavedCartsView from '@orienteed/buyLaterNotes/components/SavedCarts/savedCartsView';
...
const SavedCartTable = props => {
    ...
    if (showCopyUrl) {
        ...
        copyBtn = (
            ...
            >
                <FormattedMessage
                    id={'savedCartTable.cartCopyLinkText'}
                    defaultMessage={copyText}
                />
            </button>
        )
    }
    ...
    const savedCartTableAction = (
        <div className={classes.savedCartLink}>
            <button
                className={classes.savedCartLinkView}
                onClick={handleContentToggle}
                type="button"
            >
                <FormattedMessage
                    id={'savedCartTable.cartViewText'}
                    defaultMessage={'View'}
                />
            </button>
            <button
                id={token}
                className={classes.savedCartLinkRestore}
                type="button"
                onClick={handleRestoreSaveCart}
            >
                <FormattedMessage
                    id={'savedCartTable.cartRestoreText'}
        ...
        <div className={classes.savedCartTableRow}>
            <div className={classes.savedCartId}>
                <span className={classes.savedCartIdLabel}>
                    <FormattedMessage
                        id={'savedCartTable.savedCartIdText'}
            ...
            <div className={classes.savedCartTotal}>
                <span className={classes.savedCartTotalLabel}>
                    <FormattedMessage
                        id={'savedCartTable.savedCartTotalText'}
            ...
            <div className={classes.savedCartItem}>
                <span className={classes.savedCartItemLabel}>
                    <FormattedMessage
                        id={'savedCartTable.savedCartItemText'}
            ...
            <div className={contentClass}><SavedCartsView cart={cart} handleContentToggle={handleContentToggle} handleRestoreSaveCart={handleRestoreSaveCart} /></div>
        </div>
    );
};
