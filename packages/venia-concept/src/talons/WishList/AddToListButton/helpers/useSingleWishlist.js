...
import defaultOperations from '@magento/peregrine/lib/talons/Wishlist/AddToListButton/addToListButton.gql.js';

export const useSingleWishlist = props => {
    const { afterAdd, beforeAdd, client, customerWishlistProducts, wishListItems, item } = props;
