    ...
    return (
        <div className={classes.content}>
            <label className={classes.title}>
                <FormattedMessage id={'createAccountBeCustomer.title'} defaultMessage={'Create an Account (Be customer)'}/>
            </label>
            <Form className={classes.formContent} onSubmit={handleSendEmail}>
                ...
                <div className={classes.section}>
                    ...
                    <div className={classes.row}>
                        <Field id="email" label={formatMessage({id: 'createAccountBeCustomer.email', defaultMessage: 'Email'})}>
                            <TextInput field="email" validate={combine([
                                isRequired,
                                hasEmail,
                            ])} />
                        </Field>
                        <Field id="nif" label={formatMessage({id: 'createAccountBeCustomer.nif', defaultMessage: 'NIF'})}>
                            <TextInput field="nif" validate={isRequired} />
                        </Field>
                    </div>
                    <div className={classes.row}>
                        <Field id="nClient" label={formatMessage({id: 'createAccountBeCustomer.nClient', defaultMessage: 'Nº of Client'})}>
                            <TextInput field="nClient" validate={combine([
                                isRequired,
                                hasIntegerValue,
                            ])} />
                        </Field>
