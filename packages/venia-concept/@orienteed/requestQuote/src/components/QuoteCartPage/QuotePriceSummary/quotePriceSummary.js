...
const QuotePriceSummary = props => {
    ...
    const submitQuoteCartButton = (
        <div className={classes.submitQuoteCartButton_container}>
            <Button
                onClick={handleSubmitQuoteBtn}
                priority={'high'}
            >
                <FormattedMessage
                    id={'quotePriceSummary.submitQuoteCartButton'}
                    defaultMessage={'Submit Quote Cart'}
                />
            </Button>
        </div>
    );
        ...
        <div className={classes.root}>
            <div className={classes.lineItems}>
                <span className={classes.lineItemLabel}>
                    <FormattedMessage
                        id={'quotePriceSummary.lineItemLabel'}
                        defaultMessage={'Subtotal'}
                    />
                </span>
                <span className={priceClass}>
                    <Price
                        currencyCode={quote.quote_currency_code}
