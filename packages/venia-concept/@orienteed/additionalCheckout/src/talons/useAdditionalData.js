...
export const useAdditionalData = () => {
    ...
    const { data: customAdditionalQuoteData, loading: customAdditionalQuoteDataLoading, refetch: refectCustomAdditionalQuoteData } = useQuery(getCustomAdditionalQuoteData,{
        variables:{
            cart_id: cartId
        },
    ...
    const [setCustomAttributeQuoteSaveCall,{loading: setCustomAttributeQuoteSaveLoading}] = useMutation(setCustomAttributeQuoteSave);
    ...
    const handleAdditionalData = useCallback(()=>{
        ...
        setCustomAttributeQuoteSaveCall({
            ...
            const {data:{customAttributeQuoteSave:{status, message}}}=response
