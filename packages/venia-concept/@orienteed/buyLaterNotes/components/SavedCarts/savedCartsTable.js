...
const SavedCartTable = props => {
    ...
    return (
        <div className={classes.savedCartTableRow}>
            ...
            <div className={contentClass}><SavedCartsView cart={cart} handleContentToggle={handleContentToggle} handleRestoreSaveCart={handleRestoreSaveCart} handleDeleteSaveCart={handleDeleteSaveCart} /></div>
        </div>
    );
};
