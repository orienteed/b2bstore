module.exports = targets => {
	...
	talons.tap(({ App, Header, SearchBar }) => {
		...
		Header.useAccountMenu.wrapWith('@magento/experience-platform-connector/src/wrappers/wrapUseAccountMenu');
		SearchBar.useAutocomplete.wrapWith('@magento/experience-platform-connector/src/wrappers/wrapUseAutocomplete');
	});
};
