 ...
 *
 */
export const getToastId = ({ type, message, dismissable = true, actionText = '', icon = () => {} }) => {
...
export const useToasts = () => {
	...
	const addToast = useCallback(
		 ...
		 */
		toastProps => {
			const { dismissable, message, timeout = DEFAULT_TIMEOUT, type, onDismiss, onAction } = toastProps;
			...
			const handleAction = () => (onAction ? onAction(() => removeToast(id)) : () => {});
