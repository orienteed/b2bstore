...
const CreditCard = props => {
	...
	const { handleDeletePayment, hasError, isConfirmingDelete, isDeletingPayment, toggleDeleteConfirmation } =
		talonProps;
	...
	const deleteButton = (
		...
		>
			...
			<span className={classes.deleteText}>
				<FormattedMessage id={'storedPayments.delete'} defaultMessage={'Delete'} />
			</span>
		</LinkButton>
	);
	...
	return (
		<div className={rootClass}>
			<div className={classes.title}>
				<FormattedMessage id={'storedPayments.creditCard'} defaultMessage={'Credit Card'} />
			</div>
