...
const ForgotPasswordForm = props => {
	...
	const { initialValues, isResettingPassword, onSubmit, onCancel, recaptchaWidgetProps } = props;
	...
	return (
		...
		>
			...
			>
				<TextInput autoComplete="email" field="email" validate={isRequired} data-cy="email" />
			</Field>
