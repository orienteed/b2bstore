...
const ItemsReview = props => {
	...
	const showAllItemsFooter = !showAllItems ? <ShowAllButton onClick={setShowAllItems} /> : null;
	...
	return (
		<div className={classes.items_review_container} data-cy="ItemsReview-container">
			<div className={classes.items_container}>
				<div data-cy="ItemsReview-totalQuantity" className={classes.total_quantity}>
