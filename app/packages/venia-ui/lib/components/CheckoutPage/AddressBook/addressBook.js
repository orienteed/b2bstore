		...
		<Fragment>
			<div className={rootClass}>
				<h1 className={classes.headerText}>
					<FormattedMessage id={'addressBook.headerText'} defaultMessage={'Change Shipping Information'} />
				</h1>
				<div className={classes.buttonContainer}>
					<Button disabled={isLoading} onClick={handleCancel} priority="low">
						<FormattedMessage id={'addressBook.cancelButtonText'} defaultMessage={'Cancel'} />
					</Button>
