...
const CheckoutPage = props => {
	...
	const { deliveryDate, handleChange, submitDeliveryDate, deliveryDateData, local, deliveryDateIsActivated } =
		useDeliveryDate({});
	const { handleChangeOrderAttribute, orderAttributesData, submitOrderAttribute, orderAttributesIsActivated } =
		useOrderAttributes({});
	...
	const isMobile = windowSize.innerWidth < 959;
	let checkoutContent;
