...
const CustomerForm = props => {
	...
	const { errors, handleCancel, handleSubmit, hasDefaultShipping, initialValues, isLoading, isSaving, isUpdate } =
		talonProps;
		...
		<Fragment>
			...
			>
				...
				<div className={classes.country}>
					<Country validate={isRequired} data-cy="CustomerForm-country" />
				</div>
				...
				<div className={classes.street1}>
					<Field
						...
						optional={true}
					>
						<TextInput field="street[1]" id="customer_street1" data-cy="CustomerForm-street1" />
					</Field>
				</div>
				<div className={classes.city}>
					...
					>
						<TextInput field="city" validate={isRequired} id="customer_city" data-cy="CustomerForm-city" />
					</Field>
				</div>
				...
				<div className={classes.postcode}>
					<Postcode validate={isRequired} data-cy="CustomerForm-postcode" />
				</div>
