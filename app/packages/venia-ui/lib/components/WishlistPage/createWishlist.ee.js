...
const CreateWishlist = props => {
	...
	const { handleCreateList, handleHideModal, handleShowModal, isModalOpen, formErrors, loading, shouldRender } =
		talonProps;
		...
		<div className={classes.root}>
			...
			>
				<div className={classes.labelContainer}>
					{createIcon}
					<span>
						<FormattedMessage id={'createWishlist.handleCreateListText'} defaultMessage={'Create a list'} />
					</span>
				</div>
			</button>
			<Dialog
			...
			>
				<div className={classes.form}>
					...
					>
						<TextInput field="name" validate={isRequired} validateOnBlur data-cy="createWishlist-name" />
					</Field>
				</div>
			</Dialog>
		</div>
