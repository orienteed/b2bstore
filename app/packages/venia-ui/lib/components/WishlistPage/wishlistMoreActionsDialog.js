			...
			<div className={classes.root}>
				<button className={classes.rowButton}>
					<span className={classes.row}>
						...
						<span className={classes.text}>
							<FormattedMessage id={'wishlistMoreActionsDialog.move'} defaultMessage={'Move to'} />
						</span>
				...
				<button className={classes.rowButton}>
					<span className={classes.row}>
						...
						<span className={classes.text}>
							<FormattedMessage id={'wishlistMoreActionsDialog.copy'} defaultMessage={'Copy to'} />
						</span>
						<Icon size={16} src={ChevronRight} />
					</span>
				</button>
				<button className={classes.rowButton} onClick={onRemove}>
					<span className={classes.row}>
						...
						<span className={classes.text}>
							<FormattedMessage id={'wishlistMoreActionsDialog.delete'} defaultMessage={'Remove'} />
						</span>
					</span>
				</button>
			</div>
