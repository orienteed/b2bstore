...
const ContactPage = props => {
	...
	const { isEnabled, cmsBlocks, errors, handleSubmit, isBusy, isLoading, setFormApi, response } = talonProps;
	...
	const contactUsBannerContent = cmsBlocks.find(item => item.identifier === BANNER_IDENTIFIER)?.content;
	...
	const contactUsSidebarContent = cmsBlocks.find(item => item.identifier === SIDEBAR_IDENTIFIER)?.content;
				...
				<div className={classes.content}>
					<div className={classes.formContainer} data-cy="ContactPage-formContainer">
						...
						<h1 className={classes.title}>
							<FormattedMessage id={'contactPage.titleText'} defaultMessage={'Contact Us'} />
						</h1>
