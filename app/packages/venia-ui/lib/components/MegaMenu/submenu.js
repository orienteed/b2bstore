 ...
 */
const Submenu = props => {
	const { items, mainNavWidth, isFocused, subMenuState, handleCloseSubMenu, categoryUrlSuffix, onNavigate } = props;
	...
	const subMenuClassname = isSubMenuActive ? classes.submenu_active : classes.submenu_inactive;
	...
	return (
		<div className={subMenuClassname}>
			<div className={classes.submenuItems} style={{ minWidth: mainNavWidth + PADDING_OFFSET }}>
				{subMenus}
			</div>
		</div>
	);
