...
const CategoryFilter = props => {
	...
	const { availableCategoryItems, selectedFilter, setSelectedFilter, filterName } = props;
	const { elementRef, expanded, setExpanded } = useDropdown();

	// click event for menu items
	const handleItemClick = useCallback(
		categoryItem => {
			const tempSelectedFilters = introduceOrRemoveItemFromFilter(selectedFilter, categoryItem);
	...
	}, [availableCategoryItems, classes.menu, classes.menuItem, expanded, handleItemClick, selectedFilter]);
