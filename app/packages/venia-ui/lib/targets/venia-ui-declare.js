...
module.exports = targets => {
	targets.declare({
		 ...
		 * );
		 */
		checkoutPagePaymentTypes: new targets.types.Sync(['checkoutPagePaymentTypes']),
		 ...
		 * );
		 */
		summaryPagePaymentTypes: new targets.types.Sync(['summaryPagePaymentTypes']),

		categoryListProductAttributes: new targets.types.Sync(['categoryListProductAttributes']),
